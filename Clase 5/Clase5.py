...
def cargar_centros_datos(configuracion):
    """
    Carga los centros de datos del XML y los almacena en una lista enlazada
    
    Args:
        configuracion: Elemento XML con la configuración
        
    Returns:
        ListaEnlazada: Lista con los centros de datos
    """
...
def cargar_maquinas_virtuales(configuracion):
    """
    Carga las máquinas virtuales del XML y las almacena en una lista enlazada
    
    Args:
        configuracion: Elemento XML con la configuración
        
    Returns:
        ListaEnlazada: Lista con las máquinas virtuales
    """
    lista_vms = ListaEnlazada()
...
def mostrar_menu():
    ...
    print("\n" + "="*50)
    print("     SISTEMA DE GESTIÓN DE CENTROS DE DATOS")
    print("="*50)
    print("1. Mostrar todos los centros de datos")
    print("2. Mostrar todas las máquinas virtuales")
...
def buscar_centro(lista_centros):
    ...
    centro = lista_centros.buscar_por_id(id_buscar, 'id_centro')
...
def buscar_vm(lista_vms):
    ...
    vm = lista_vms.buscar_por_id(id_buscar, 'id_vm')
...
def main():
    ...
    try:
        tree = ET.parse("Clase 5\\entrada.xml")
        root = tree.getroot()
        configuracion = root.find("configuracion")
        
        # Cargar datos en listas enlazadas
