...
class ListaDobleCentros:
    """
    Clase que representa una lista doblemente enlazada para Centros de Datos
    """
    ...
    def eliminar_por_id(self, id_buscado):
        """
        Elimina un centro de datos de la lista por su ID
    ...
    def graficar(self, nombre_archivo="lista_centros"):
        """
        ...
        dot_content = 'digraph ListaDobleCentros {\n'
        ...
        while actual is not None:
            label = f"{actual.dato.id_centro}|{actual.dato.nombre}|{actual.dato.ciudad}"
